...
export const homeSections = pgTable("home_sections", {
  ...
  description: text("description"),
  layoutType: text("layout_type").notNull().default("grid"), // 'grid', 'featured', 'mixed', 'festival', 'festival-specials', 'countdown-banner', 'mosaic', 'magazine', 'carousel', 'royal', 'curved-grid', 'tilted-grid'
  isActive: boolean("is_active").notNull().default(true),
  displayOrder: integer("display_order").default(0),
